    ...
    <footer className="footer-section section-bg-3">
          ...
          <div className="row">
            ...
            >
              <div className="single-footer-widget" >
                <div className="widget-head">
                  <Link href="/">
                    <img src="assets/img/logo/logobranco.svg" alt="logo-img" 
            ...
            >
              <div className="single-footer-widget">
                ...
                <div className="footer-address-text">
                  <p>Bairro Malí, Marracuene, Moçambique</p>
                </div>
              </div>
            </div>
            <div
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="footer-wrapper d-flex align-items-center justify-content-between">
            <p className="wow fadeInLeft color-2" data-wow-delay=".3s">
            Copyright © 2025 <Link href="/">Água de Malí</Link>
            </p>
            <ul className="footer-menu wow fadeInRight" data-wow-delay=".5s">
              <li>
                <Link href="/">Desenvolvido pela Datechs</Link>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="container">
        ...
        <div className="footer-bottom-4">
          <p className="wow fadeInUp text-center" data-wow-delay=".3s">
            Copyright © 2025 <Link href="/">Água de Malí</Link>. Todos direitos reservados
          </p>
        </div>
      </div>
    </footer>
