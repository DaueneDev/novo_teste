  ...
  return (
    ...
    >
      <div className="testimonial-card-items">
        ...
        <p>
        "Graças à Águas de Mali, nossa comunidade 
        nunca mais sofre com falta de água. A qualidade
         dos serviços e o atendimento local fizeram toda
          a diferença. Recomendo a Águas de Mali pela
           confiabilidade.
        </p>
        <ul>
          <li>21 de Abril de 2025</li>
        </ul>
      </div>
      <div className="testimonial-card-items">
        <div className="author-items">
      ...
      <div className="testimonial-card-items">
        ...
        <p>
        “Águas de Mali transformou nossa
         realidade. Hoje temos água limpa todos os dias, 
